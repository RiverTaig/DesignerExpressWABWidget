...
define([
  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      baseClass: 'jimu-widget-designerExpress-setting',
      selectLayer: null,
      tooltipDialog: null,
      featurelayers: [],
      indexLayer : -1,
      ...
      startup: function() {
        ...
        this.enableUndoRedo.set('checked', this.config.editor.enableUndoRedo);
		    this.userName.set('value', this.config.editor.userName);
		    this.serviceURL.set('value', this.config.editor.serviceURL);
        this.popupHeight.set('value', this.config.editor.popupHeight);
        this.popupWidth.set('value', this.config.editor.popupWidth);
        this.showJson.set('checked', this.config.editor.showJson);
        ...
        this.own(on(this.displayLayersTable,
                    'actions-edit',
      ...
      getConfig: function() {
        this.config.editor.enableUndoRedo = this.enableUndoRedo.checked;
		    this.config.editor.userName = this.userName.value;
		    this.config.editor.serviceURL = this.serviceURL.value;
        this.config.editor.popupHeight = this.popupHeight.value;
        this.config.editor.popupWidth = this.popupWidth.value;
        this.config.editor.showJson = this.showJson.checked;
